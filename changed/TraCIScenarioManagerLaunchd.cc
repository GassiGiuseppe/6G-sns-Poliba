...
{
    {
        ...
        if (apiVersion == 1) {
            ...
            // Modified by Gassi Giuseppe at Politecnico di Bari
            ...
            EV_DEBUG << "TraCI server \"" << serverVersion << "\" reports API version " << apiVersion <<  ". It seems not supportedbut we will proceed anyway" << endl;
        }
    }
